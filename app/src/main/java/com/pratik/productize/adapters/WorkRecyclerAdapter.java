...
public class WorkRecyclerAdapter extends RecyclerView.Adapter<WorkRecyclerAdapter.MyViewHolder> {
    ...
    public WorkRecyclerAdapter(Context context,RecyclerViewClickListener itemClickListener){
